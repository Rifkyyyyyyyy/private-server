...
var _techStackValidation = require("../../validation/tech-stack-validation.js");
 ...
 */
var createTechStack = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(request) {
    var name, category, userId, result;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          (0, _validation.validate)(_techStackValidation.techStackValidation, {
            name: request.name,
            category: request.category
          });
          name = request.name, category = request.category, userId = request.userId;
          if (userId) {
            _context.n = 1;
            break;
          }
        ...
        case 1:
          _context.n = 2;
          return _database.prismaClient.techStack.create({
            data: {
              name: name,
              category: category,
              userId: userId
  ...
  return function createTechStack(_x) {
 ...
 * @param {Object} request 
 */
var updateTechStack = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(id, request) {
    var existing, name, category;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        case 0:
          _context2.n = 1;
          return _database.prismaClient.techStack.findUnique({
            where: {
              id: id
            }
          });
        case 1:
          ...
          throw new _apiErrorUtils.ApiError(_httpStatusCodes.StatusCodes.NOT_FOUND, 'Tech Stack tidak ditemukan');
        case 2:
          (0, _validation.validate)(_techStackValidation.techStackValidation, {
            name: request.name,
            category: request.category
          ...
          _context2.n = 3;
          return _database.prismaClient.techStack.update({
            where: {
              id: id
            },
            data: {
  ...
  return function updateTechStack(_x2, _x3) {
 ...
 * @param {string} userId 
 */
var getAllTechStacks = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(page, limit, userId) {
    var _getPagination, skip, take, metadata, _yield$Promise$all, _yield$Promise$all2, data, total;
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.n) {
        ...
        case 1:
          ...
          _context3.n = 2;
          return Promise.all([_database.prismaClient.techStack.findMany({
            where: {
              userId: userId
            },
            skip: skip,
          ...
          }), _database.prismaClient.techStack.count({
            where: {
              userId: userId
            }
          })]);
  ...
  return function getAllTechStacks(_x4, _x5, _x6) {
 ...
 * @param {string} id 
 */
var deleteTechStack = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(id) {
    ...
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.n) {
        ...
        case 2:
          _context4.n = 3;
          return _database.prismaClient.techStack["delete"]({
            where: {
              id: id
            }
          });
  ...
  return function deleteTechStack(_x7) {
 ...
 * @param {string} userId 
 */
var getTechStackByUserId = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5(userId) {
    ...
    return _regenerator().w(function (_context5) {
      while (1) switch (_context5.n) {
        ...
        case 3:
          _context5.n = 4;
          return _database.prismaClient.techStack.findMany({
            where: {
              userId: user.id
            },
            orderBy: {
        ...
        case 4:
          techStacks = _context5.v;
          return _context5.a(2, techStacks);
      }
    }, _callee5);
  }));
  return function getTechStackByUserId(_x8) {
...
var _default = exports["default"] = {
  ...
  getAllTechStacks: getAllTechStacks,
  deleteTechStack: deleteTechStack,
  getTechStackByUserId: getTechStackByUserId
};