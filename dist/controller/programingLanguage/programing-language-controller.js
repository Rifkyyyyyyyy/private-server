...
var _progamingLanguageService = _interopRequireDefault(require("../../service/progaming/progaming-language-service.js"));
 ...
 * @access Private
 */
var createProgrammingLang = (0, _catchAsyncUtils.catchAsync)(/*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(req, res) {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          _context.n = 1;
          return _progamingLanguageService["default"].createProgrammingLang(_objectSpread(_objectSpread({}, req.body), {}, {
            userId: req.user.id
          }));
        case 1:
          data = _context.v;
 ...
 * @access Private
 */
var updateProgrammingLang = (0, _catchAsyncUtils.catchAsync)(/*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(req, res) {
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        case 0:
          _context2.n = 1;
          return _progamingLanguageService["default"].updateProgrammingLang(req.params.id, req.body);
        case 1:
          progamming = _context2.v;
 ...
 * @access Private
 */
var deleteProgrammingLang = (0, _catchAsyncUtils.catchAsync)(/*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(req, res) {
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.n) {
        case 0:
          _context3.n = 1;
          return _progamingLanguageService["default"].deleteProgrammingLang(req.params.id);
        case 1:
          res.status(_httpStatusCodes.StatusCodes.OK).json({
            success: true,
 ...
 * @access Private
 */
var getAllProgrammingLangs = (0, _catchAsyncUtils.catchAsync)(/*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(req, res) {
    var page, limit, userId, _yield$programmingLan, data, metadata;
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.n) {
        case 0:
          page = parseInt(req.query.page) || 1;
          limit = parseInt(req.query.limit) || 5;
          userId = req.user.id; // ✅ Ambil userId dari pengguna yang login
          // ✅ Memanggil service dengan parameter userId dan mengambil data + metadata
          _context4.n = 1;
          return _progamingLanguageService["default"].getAllProgrammingLangs(page, limit, userId);
        case 1:
          _yield$programmingLan = _context4.v;
          data = _yield$programmingLan.data;
          metadata = _yield$programmingLan.metadata;
          res.status(_httpStatusCodes.StatusCodes.OK).json({
            success: true,
            msg: 'Daftar bahasa pemrograman berhasil diambil.',
            data: data,
            metadata: metadata // ✅ Sertakan metadata untuk pagination
          });
        case 2:
 ...
 * @access Public
 */
var getProgrammingLangsByUserId = (0, _catchAsyncUtils.catchAsync)(/*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context5) {
      while (1) switch (_context5.n) {
        case 0:
          ...
          userId = req.user.id;
          _context5.n = 1;
          return _progamingLanguageService["default"].getProgrammingLangsByUserId(userId);
        case 1:
          data = _context5.v;
          res.status(_httpStatusCodes.StatusCodes.OK).json({
            success: true,
            msg: "Daftar bahasa pemrograman untuk pengguna ".concat(userId, " berhasil diambil."),
            data: data
          });
        case 2:
...
var _default = exports["default"] = {
  ...
  getProgrammingLangsByUserId: getProgrammingLangsByUserId // ✅ Menambahkan fungsi baru
};